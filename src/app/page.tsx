...
// arc, distilled from the retrospective into brand voice.
      ...
      <main className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <section className="pt-20 sm:pt-28">
          ...
          <p className="mt-5 max-w-[46ch] font-serif text-xl italic text-paper sm:text-2xl">
            Mohammed Kenawy — an early-career backend engineer in Egypt, working
            bilingually in Arabic and English.
          </p>
          ...
          <div className="grid grid-cols-1 gap-x-12 gap-y-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
            <div className="prose-measure">
              ...
              <p className="mt-4 font-serif text-lg text-paper">
                ...
                three narrator voices — a skeptic, a chronicler, a believer —
                with an interactive council and an appendix mapping every symbol
                to its distributed-systems concept. It is the piece I would point
                to first.
              </p>
            </div>
            <a
        ...
        <div className="mt-16 grid grid-cols-1 gap-x-16 gap-y-10 lg:grid-cols-[minmax(0,1fr)_260px]">
          <article className="prose-measure font-serif text-lg">
            ...
            <p className="mb-5">
              It began, as these things do, with a dissatisfaction. In 2022 I
              was the clean-code guy; clean code was my identity, and I thought
              passion and a tidy codebase were enough. They were not. Every
              time I decided I knew enough, a new context arrived to correct me
              — an academic year, military service, an undocumented legacy
              system, a first real job.
            </p>

            <p className="mb-5">
              The lesson I paid for most recently, and most literally: data
              migrations cost more than you think. On my first industry team —
              small enough that &ldquo;backend engineer&rdquo; meant planning,
              ...
              touching the data. I know that now because we did it the other
              way.
            </p>

            <p className="mb-5">
              What came after was where the work got interesting. A
              deterministic payroll engine with retroactive recalculation, which
              became my entry into fintech and double-entry ledgers. A
              metadata-driven reporting and export subsystem — BullMQ queues,
              Redis, background workers, notifications over SSE, and enough
              failure modes to justify chaos testing it. A biometric attendance
              gateway with two reconciliation paths and idempotent
              deduplication. None of it is glamorous. All of it has to be right.
            </p>

            <p className="mb-5">
              Before the job there was the army, where I became — by seniority,
              not design — a leader of four. I had always thought vertically:
              one problem, deep. There the pressure was horizontal, many small
              things at once, more than one head holds. I learned to write
              everything down, to share the load, and to document a workflow so
              the next person would not start from zero. That last idea has
              stayed with me as something closer to a principle than a habit.
            </p>
            ...
            <p>
              ...
              ship the mechanism, and document the journey — then read again.
              The code is the exhaust of that loop. What I&apos;m trying to leave
              behind is systems the next person can inherit.
            </p>
          </article>

          {/* Reading margin — read + learn (design.md §5). */}
          <aside
            aria-label="Reading trail"
            className="border-t border-hairline pt-6 lg:border-l lg:border-t-0 lg:pl-8"
          >
            <div className="mb-7">
